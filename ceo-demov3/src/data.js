...
export const applications = [
  ...
  },
  {
    ...
    insight: 'Due tomorrow. Finishing it is the only thing standing between you and a round.',
  ...
  /* ---- Interview scheduled: one booked round, one already sat ------------------ */
  {
    ...
    insight: 'Round 1 of 5. Nobody can pick one but you, and they do expire.',
  ...
  },
  {
    ...
    insight: 'No email reports how a round actually went. Thirty seconds, and your next round gets sharper.',
  ...
  /* ---- Ghosted: three origins, three different follow-ups --------------------- */
  {
    ...
    when: 'Applied 52d ago · no reply', action: 'Send a nudge', flow: 'ghosted',
    insight: 'Fifty-two days since you applied. Past forty-five, waiting stops being a strategy. The nudge is written.',
  ...
  },
  {
    ...
    when: 'Interviewed 14d ago · no update', action: 'Ask where it stands', flow: 'ghosted',
    insight: 'You sat a round fourteen days ago and heard nothing. Asking is normal, and the note is written.',
  ...
  },
  {
    ...
    insight: 'You already sent one note. Nine days on, closing it is the only move left that is yours.',
